...
def get_zotero_client() -> zotero.Zotero:
    ...
    This version only supports the web API (no local API).
...
def generate_bibtex(item: Dict[str, Any]) -> str:
    ...
    try:
        from zotero_web_mcp.better_bibtex_client import ZoteroBetterBibTexAPI
